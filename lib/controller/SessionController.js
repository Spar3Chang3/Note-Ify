...
export default class SessionController {
  ...
  async pause() {
    ...
    await this.textChannel.send("I've left the call while you guys take a break. Just send `@bot unpause` whenever you're ready to resume playing!");
  ...
  async stop() {
    ...
    for (const summary of SplitMessage(summaryContent ?? "")) {
    ...
    collector.on("collect", async (feedback) => {
      ...
      for (const chunk of SplitMessage(revised ?? "")) {
